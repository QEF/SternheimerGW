...
!      USE io_global, ONLY : stdout
      USE parameters,     ONLY : DP, dbl, i4b, stdout
!@@
...
!     INTEGER, PRIVATE, PARAMETER :: mp_msgsiz_max = 1000000000
      INTEGER, PRIVATE, PARAMETER :: mp_msgsiz_max = 2000000000  !@FG to allow passing kmeshes of size 300^3
! this limit corresponds to approx. 950Mb
