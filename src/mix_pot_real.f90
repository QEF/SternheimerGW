...
!
!-----------------------------------------------------------------------
subroutine mix_potential_real (ndim, vout, vin, alphamix, dr2, tr2, &
  ...
  ! defined as real... 2*nrxx which makes this consistent
  ! with the arrays being defined as complex in solve_linter.
...
!#endif
  ...
  call stop_clock ('mix_pot')
  return
end subroutine mix_potential_real
