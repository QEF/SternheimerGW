...
!For crystals without inversion symmetry we pray for a symmetry operations  Sq -> -q +G
 ...
 !Also the kpoints are generated assuming time reversal symmetry however rotating q requires
 !inversion. But for systems without inversion this could be an issue.  Possible solutions are 
 !1) Give up, join a monastery and commit myself to a life of good deeds (simplest). 
 !2) Hope that Sq = -q + G will solve all my problems. (it doesn't)
 !3) Time reversal gives -q?
 !4) Calculate at all the minus q as well...

 !   But you must know there is no hope?
 !   No! I refuse to admit that possibility.
 !  (aside) Lord, What fools these mortals be. 
