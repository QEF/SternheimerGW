  ...
  ! (this is to implement the direct minimization method of Paratec)
  !
  !-----------------------------------------------------------------------
  !
  ...
  !
  integer :: maxbcgsolve, & ! input: run only maxbcgsolve iterations
             ndmx, & ! input: the maximum dimension of the vectors
