...
\caption{\label{fig.diel}
        ...
        In this case we used a uniform $24\times 24\times 24$ BZ grid
        and a 0.1 eV imaginary frequency in order to represent the singularities
        (the behavior at w=0 is considerably smoother).
        }
\end    {figure}
