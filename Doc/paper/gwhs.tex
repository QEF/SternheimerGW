...
In the case of a real-space calculation we would have
...
a small G-grid (already done), and put in 1-to-1 correspondence to
the r-grid (i.e. box to box, not box to sphere); (2) create a delta 
on the small r-grid,
(3) small-fft (special box to box) on the small G-grid, 
(4) pad with 0s, (5) go back to
real space (dense grid) using normal fft. Enter solve-linter,
get the result in r-space, normal FFT back to G-space, and chop
on the small cutoff.
