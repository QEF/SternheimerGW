...
\subsubsection{Scaling of the screened Coulomb calculation}\label{sec.coulomb.scaling}

\subsubsection{Scaling of the Green's function calculation}\label{sec.green.scaling}
