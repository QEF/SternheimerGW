...
the calculation of the static dielectric matrix for consistency with Ref.\ \onlinecite{hl86}.
...
at long wavelenght with the data calculated in Ref.\ \onlinecite{hl86}. 
...
with the calculations of of Ref.\ \onlinecite{blochl} performed within the local density
...
point and for the conduction band edge to the results of Refs.\ \onlinecite{hl86,blochl}.
...
of Ref.\ \onlinecite{blochl} relative to the case of the $GW$ self-energy
(in Ref.\ \onlinecite{blochl} the authors used $N=12$). 
