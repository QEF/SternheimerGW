...
using silicon as a test case. We examine the advantages and
...
found in Refs.\ \onlinecite{hl,gunnarsson,reining-review,rinke,wilkins}.
...
how the DFPT formalism can be adapted to perform $GW$ calculations.
...
standard expression [e.g.\ Eq.\ (22) of Ref.\ \onlinecite{hl86}], due
...
of Ref.~\onlinecite{cohen.diel1} at large wavevectors can likely be ascribed to the use of a limited 
...
at long wavelength with the results reported in Ref.\ \onlinecite{hl86}. 
...
we decided to adopt Eq.\ (\ref{eq.specfun}) to be consistent with Ref.\ \onlinecite{blochl}.
...
using the self-consistent Sternheimer equation ($GW$-S). We show how
