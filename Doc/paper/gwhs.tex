...
through
  ...
  \end{equation}
By adopting the same convention as for the screened Coulomb interaction Eq.\ (\ref{eq.w.bloch})
...
METTI DEFINITIONS OF DELTA-CHARGE COME W AND G. DO NOT PROVIDE DERIVATION,
JUST EXPLAIN PHYSICS AND GIVE FINAL FORMULAS.
...
${\rm e}^{i\q\cdot\rp}$ in the variable $\rp$.
